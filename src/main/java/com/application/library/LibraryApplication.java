...
public class LibraryApplication {
	...
	public CommandLineRunner initialCreate(BookService bookService) {
		return args -> {
			Book book1 = new Book("ISBN-001", "Book name", "My first book");
			...
			Book book2 = new Book("ISBN-002", "Book name", "My first book");
			...
			Book book3 = new Book("ISBN-003", "Book name", "My first book");
